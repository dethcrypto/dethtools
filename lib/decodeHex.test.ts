...
describe('decodeHex', () => {
  ...
  it('handles trivial cases', () => {
    ...
    expect(decodeHex('0xafafafafafafafa000000fafafa')).toEqual('222708811334214420065425739676410')

    expect(decodeHex('0x059445e1317134A3F20D95A06Df5A36443a833f5')).toEqual(
      '31851551520483547527162890012382687127533007861',
    )
    expect(decodeHex('0x43ff17839cf09ffe577742a85b07fa375db13e2f1f6f21b0c960fee34cc58c60')).toEqual(

...
export function Navigation({ handleShowMobileTree }: { handleShowMobileTree: (width: number) => void }) {
  ...
  return (
    <nav className="mx-auto flex h-20 items-center justify-between px-8 pt-6 pb-4 sm:px-0">
      <section className="flex cursor-pointer items-center gap-4">
        <Image className="" src="/static/svg/logo.svg" width={36} height={36} alt="deth tools logo" />
        {width > 480 && (
          <Image className="" src="/static/svg/deth-tools.svg" width={164} height={164} alt="deth tools logo" />
        )}
        <p> WIP </p>
      </section>
